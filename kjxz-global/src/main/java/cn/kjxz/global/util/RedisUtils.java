   ...
   /* public boolean setnxAndExpire(String key,Object value,long expire){
    ...
    public  List<Object> lrange(String key, long start,long end) {
        try {
            ...
            return objectList==null||objectList.size()==0?null:objectList;
        } catch (Exception e) {
            log.error("redis lrem error,key:{},start:{},end:{},exception:{}",key,start,end,e);
            return null;
        }
    }
    ...
    public boolean hset(String key, String field, Object value) {
        try {
            ...
            log.error("redis hset key:{},field:{},value:{},e:{}",key,field,value,e);
            return false;
        }
    }
    ...
    public Map<Object, Object> hmget(String key){
        ...
        return entries==null||entries.size()==0?null:entries;
    }
    ...
    public Object spop(String key){
        try {
            ...
            log.error("redis spop error,key:{},values:{},exception:{}",key,e);
            return 0;
        }
    }
